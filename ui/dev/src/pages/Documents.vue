<template>
  ...
  <!-- <div class="row">
        ...
        <div class="col-12 col-md-4 text-center"><img class="margin-0" style="height: 300px" src="statics/documents/leaflet.jpg" ></div>
        <div class="col-12 col-md-4 text-center"><img class="margin-0" style="height: 300px" src="statics/documents/reracertificate.jpg" ></div>
        <div class="col-12 col-md-4 text-center"><img class="margin-0" style="height: 300px" src="statics/documents/draftlayoutletterhmda.jpg" ></div>
        <div class="col-12 col-md-4 text-center"><img class="margin-0" style="height: 300px" src="statics/documents/layout.jpg" ></div>
        <div class="col-12 col-md-4 text-center"><img class="margin-0" style="height: 300px" src="statics/documents/municipalapproval.jpg" ></div>
  </div>-->
</template>
